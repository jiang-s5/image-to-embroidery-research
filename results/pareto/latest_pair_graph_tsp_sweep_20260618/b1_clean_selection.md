...
- recommended method: `b2_graph_tsp_conservative_safe`
- mean unified loss: `0.626582`
- mean visual risk: `0.277211`

## Pareto Front

| Method | Samples | Unified Loss | Jump | Trim | Off-Mask mm | Visible Connectors | Jump Path mm | Hard Fail | Warning |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| b2_graph_tsp_conservative_safe | 4 | 0.626582 | 213.500 | 26.250 | 175.534 | 35.250 | 1011.602 | 4 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| b2_graph_tsp_conservative_safe | 0.626582 | 0.349371 | 0.277211 | 4 | 0 | 0 | 0 |
| b2_graph_tsp_safe | 0.628021 | 0.350810 | 0.277211 | 4 | 0 | 0 | 0 |
